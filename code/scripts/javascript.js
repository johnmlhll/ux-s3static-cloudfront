...
function loadImages() {
    setInterval(function() {
        swapImage('slideshow_csharp', [
            "img/imgLogoCSharpVS.jpg",
            "img/imgLogoMicrosoftSQLServer.png",
            "img/imgLogoJava8.png"
        ]);
        swapImage('slideshow_bash', [
            "img/imgLogoBash.png",
            "img/imgLogoDotNet.png",
            "img/imgLogoPostgreSQL.png"
        ]);
        swapImage('slideshow_xml', [
            "img/imgLogoXML.png",
            "img/imgLogoASPNETMVC.png",
            "img/imgLogoHtml5Css3Js.png" 
        ]);
        swapImage('slideshow_android', [
            "img/imgLogoAndroid.png",
            "img/imgLogoAngular4TS.png",
            "img/imgLogoMySQL.png"    
        ]);
        swapImage('slideshow_python', [
            "img/imgLogoPython.png",
            "img/imgLogoLinux.png",
            "img/imgLogoFirebase.jpg"
        ]);
    }, 3000);
}